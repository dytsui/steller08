    ...
    >
      <section className="stats-grid">
        <Card className="stack">
          <strong>平台用户数</strong>
          <span className="page-title" style={{ fontSize: 32 }}>
            {userCount}
          </span>
        </Card>
      ...
      <section className="modes-grid">
        <Card className="stack">
          <strong>Pro 价值</strong>
          <span className="muted">
            学员管理、分析复盘、训练计划、邀请绑定，统一沉淀在一个工作台。
          </span>
        </Card>
        ...
        <Card className="stack">
          <strong>业务定位</strong>
          <span className="muted">
            Pro端不是后台杂糅页，而是高尔夫训练业务工作台。
          </span>
          <Link href="/pro/students">
            <span className="button button-primary">进入用户管理</span>
          </Link>
        </Card>
      </section>
    </PortalShell>
